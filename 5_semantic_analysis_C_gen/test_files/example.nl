|*
 ...
 9) la seconda chiamata di sommac passava solo gli argomenti a, b e taglia. È stata modificata aggiungendo l'argomento
    x come nella prima chiamata.
|
...
def esempio(): void{
	...
	stampa("la somma di " & a & ", " & b & " e " & x & " incrementata di " & c & " è " & taglia);
...
la somma di 50, 60.0 e 3 incrementata di 1 è grande
ed è pari a 114.0
vuoi continuare? (si/no) - inserisci due volte la risposta	
no  
no
